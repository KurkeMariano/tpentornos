...
<?php
   ...
   include 'funciones/traeralumnos.php';
...
<div class="page-content">
   <div class="row">
      <div class="col-md-2">
         ...
         <?php 
            if(!$_GET){
                header('Location: ./editaralumno.php?pagina=1');
            }
                     ...
                     <nav>
                        <ul class="pagination">
                           <li class="page-item
                              ...
                              ">
                              <a class="page-link" href="editaralumno.php?pagina=<?php echo $_GET['pagina']-1 ?>">
                              Anterior
                              </a>
                           </li>
                           <?php for($i=0;$i<$paginas;$i++): ?>
                           <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
                              <a class="page-link" href="editaralumno.php?pagina=<?php echo $i+1 ?>">
                              <?php echo $i+1 ?>
                              </a>
                           </li>
                           <?php endfor ?>
