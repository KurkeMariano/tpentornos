...
if($cantidad > 0){
    ...
    $sql= "INSERT INTO usuario(`tipo_usuario`, `desc_usuario`, `DNI`, `usuario`, `password`, `nombre`, `apellido`, `fecha_nacimiento`, `mail`, `telefono`, `provincia`, `ciudad`,  `direccion`, `piso`, `dpto`, `instrumento`, `fecha_ingreso`, `fecha_egreso`, `activo`) VALUES (1,'alumno','$dni','$usuario','$password','$nombre','$apellido','$fechanacimiento','$email','$telefono','$cbx_provincia','$cbx_ciudad','$direccion','$piso','$dpto','$instrumento',CURRENT_DATE(),NULL,1)";
