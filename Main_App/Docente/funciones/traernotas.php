<?php
    ...
    $sql = "select dni, nombre, apellido, mail, nota_parcial, nota_final from usuario where tipo_usuario = 1 order by apellido, nombre, dni limit $inicial,$usuariosporpagina";
